    ...
    <MenuHeaderWrapper className='nav-header' sx={{ pl: menuHeaderPaddingLeft() }}>
      {userNavMenuBranding ? (
        ...
        <LinkStyled href='/'>
          ...
          {menuCollapsedStyles.opacity == 0 && (
            <img
              style={{ width: '50px', height: '58px', marginTop: '20px', marginBottom: '20px' }}
              // src="/svg_logos/cronberry_miniLogo.svg"
