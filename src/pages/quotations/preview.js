              ...
              <div className='a4-background'>
                ...
                <div className='price-section' style={{ marginRight: 'auto', marginLeft: 'auto', width: '100%' }}>
                  ...
                  <div className='price-section-state'>
                    {' '}
                    <span className='city-name-here'>Rajasthan</span> &#20;|&#20;{' '}
                ...
                <div className='days-section'>
                  <h3 className='itinerary-title'>Day 1 | Arrival in Jaipur</h3>
                  ...
                  <div>
                    <p className='day-description'>
                      ...
                      arrival, check in at Hotel Shyam. Complete the check-in process, rest for two hours, and then head
                      out to explore:
                    </p>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', marginTop: '20px' }}>
                      <img src='/sightseeing-icon.png' width='20px' style={{ marginRight: '10px' }} />
                      <p className='day-attraction-dexcription'>
                        <b>Jantar Mantar : </b>A UNESCO World Heritage Site showcasing ancient astronomical instruments.{' '}
                      </p>
                    </div>
                    <p className='day-description'>
